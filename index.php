                            ...
                            <div class="d-grid gap-1">
                                <form action="" method="get">
                                    <div class="btn-group-vertical w-100">
                                        <button name="moodCommand" type="submit" class="btn w-100 btn-primary mb-2" value="HAPPY">HAPPY</button>
                                        <button name="moodCommand" type="submit" class="btn w-100 btn-primary mb-2" value="SAD">SAD</button>
                                        <button name="moodCommand" type="submit" class="btn w-100 btn-primary mb-2" value="SKULL">SKULL</button>
                                        <button name="moodCommand" type="submit" class="btn w-100 btn-primary mb-2" value="HEART">HEART</button>
                                        <button name="moodCommand" type="submit" class="btn w-100 btn-primary mb-2" value="SILLY">SILLY</button>
                                    </div>
                                </form>
                            </div>
                        </div>
